...
public class ExportRequestController extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
          ...
          exportRequest.setDayRequest(new java.sql.Date(System.currentTimeMillis())); // Sửa: sử dụng java.sql.Date
          ...
          if (exportRequestId != null && !exportRequestId.trim().isEmpty()) {
              ...
              if (!items.isEmpty()) {
                  ...
                  if (itemsAdded) {
                      ...
                      request.setAttribute("currentUser", fullname);
                      request.setAttribute("requestDate", new SimpleDateFormat("dd/MM/yyyy").format(new Date()));
                      ...
                      System.out.println("- requestDate: " + new SimpleDateFormat("dd/MM/yyyy").format(new Date()));
  ...
  public String getServletInfo() {
      return "Export Request Controller - Improved Version";
  }
}