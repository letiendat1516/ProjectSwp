...
<html lang="vi">
  ...
  <body>
      <div class="container">
                              ...
                              <tr class="${rowClass}">
                                  ...
                                  <td>
                                      <div class="action-buttons-cell">
                                          ...
                                          <c:choose>
                                              <c:when test="${req.status == 'completed' || req.status == 'quoted'}">
                              ...
                              <tr class="detail-row">
                                  <td colspan="7">
                                    <div style="margin-bottom: 10px;">
                                         <strong>Gợi ý nhà cung cấp:</strong> ${req.supplier != null ? req.supplier : "Chưa có"}</p>
                                          <p><strong>Địa chỉ:</strong> ${req.address != null ? req.address : "Chưa có"}</p>
                                          <p><strong>SĐT:</strong> ${req.phone != null ? req.phone : "Chưa có"}</p>
                                          <p><strong>Email:</strong> ${req.email != null ? req.email : "Chưa có"}</p>
                                      </div>
          ...
          <div class="footer">
              <a href="usermanager" class="btn-secondary">
