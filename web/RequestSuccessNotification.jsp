...
<body>
    <div class="container">
        ...
        <div class="button-group">
            <a href="${pageContext.request.contextPath}/RequestForward.jsp" class="btn btn-home">Quay Về</a>
            <a href="loadingrequest" class="btn btn-continue">Tiếp Tục Điền Form</a>
        </div>
    </div>
</body>
</html>