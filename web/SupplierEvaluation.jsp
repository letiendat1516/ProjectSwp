...
<html>
    <head>
        ...
        <style>
            ...
            /* Nút Back - đặt trong content area thay vì fixed */
            .back-btn {
                display: inline-flex;
                align-items: center;
                gap: 7px;
                position: static; /* Bỏ position fixed/absolute */
                margin: 30px 0 20px 50px; /* Thêm margin để định vị */
            ...
            .back-btn::before {
                content: "←"; /* Thay đổi icon arrow */
                font-size: 16px; /* Giảm size icon */
                margin-right: 5px;
